...
namespace AcidarX.Core.Input
{
    ...
    public static class AXInputCodeMapper
    {
        ...
        public static MouseButton AXMouseButtonToSilkMouseButton(AXMouseButton mouseButton) => (MouseButton) mouseButton;
        
        public static AXKey SilkKeyToAXKey(Key key) => (AXKey) key;
        public static AXMouseButton SilkMouseButtonToAXMouseButton(MouseButton mouseButton) => (AXMouseButton) mouseButton;
    }
}